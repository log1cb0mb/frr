    ...
    raw_config = {
        "r1": {
            "raw_config": [
                ...
                "mgmt commit check",
                "mgmt delete-config /",
                "mgmt load-config FILE merge",
                "mgmt load-config FILE replace",
                "mgmt lock-database candidate",
                "mgmt rollback last 2",
                "mgmt rollback last",
                "mgmt save-config running FILE",
